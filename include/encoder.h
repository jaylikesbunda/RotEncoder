...
/* Number of samples kept for RPM averaging */
#ifndef ENCODER_RPM_SMOOTHING_SIZE
#define ENCODER_RPM_SMOOTHING_SIZE 4
#endif

/** Encoder latch positions (see Matthias Hertel’s Arduino Encoder library) */
typedef enum {
...
/** Direction reported by encoder_get_direction() */
typedef enum {
    ENCODER_DIR_NONE = 0,
    ENCODER_DIR_CW   = 1,
    ENCODER_DIR_CCW  = -1
